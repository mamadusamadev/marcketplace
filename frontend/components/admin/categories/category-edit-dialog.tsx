...
export function CategoryEditDialog({ open, onOpenChange, category, onSubmit }: CategoryEditDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Atualize as informações da categoria "{category.name}".</DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Nome do ícone ou URL" {...field} value={field.value || ""} />
                  </FormControl>
